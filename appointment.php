...
<head>
    ...
    <title>Salon d' Margz || Appointments Form</title>
    <!-- Bootstrap -->
...
<?php $query=mysqli_query($con,"select * from tblserve",);
              while($row=mysqli_fetch_array($query))
              {
              ?>
                               <option value="<?php echo $row['ServiceName'];?>"><?php echo $row['ServiceName'];?></option>
							   ...
							   <?php $query=mysqli_query($con,"select * from tblservicing",);
              while($row=mysqli_fetch_array($query))
              {
              ?>
                               <option value="<?php echo $row['ServiceName'];?>"><?php echo $row['ServiceName'];?></option>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="copyright-content">
                                <p>© Salon d' Margz  | all rights reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
