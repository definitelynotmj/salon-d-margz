...
<head>
    ...
    <title>Salon d' Margz || Service List</title>
    <!-- Bootstrap -->
   ...
   <?php include_once('includes/header.php');?>
    ...
    <div class="content">
        <div class="container">
            ...
            <p> <b>Great hair doesn't happen by chance, it happens by appointment, Book yours now! </b></p>
          </div>
		  <br>
		 <br> <br> <font size="+4"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; HAIR SERVICES </font>
...
$cnt=$cnt+1;
			    ...
			    <br> <br> <font size="+4">  SPA SERVICES </font>
               <table class="table table-bordered"> <thead> <tr> <th>No.</th> <th>Service Name</th> <th>Service Price</th> <th>Service Description</th> </tr> </thead> <tbody>
<?php
$ret=mysqli_query($con,"select *from  tblservicing");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {
...
$cnt=$cnt+1;
			    ...
			    <br> <br> <font size="+4">  PROMO </font>
               <table class="table table-bordered"> <thead> <tr> <th>No.</th> <th>Service Name</th> <th>Service Price</th> <th>Service Description</th> </tr> </thead> <tbody>
<?php
$ret=mysqli_query($con,"select *from  tblserve");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-sm-7 col-md-8 col-xs-12">
                    ...
                    <p class="cta-text"> Click the button to start booking!</p>
                </div>
